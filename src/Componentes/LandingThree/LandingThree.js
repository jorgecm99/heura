  ...
  return (
    <div className='landing-three'>
      ...
      <div className='landing-three-card-one'>
        ...
        <p>Ahorramos los litros de agua equivalentes a <strong className='strong-underline'>100.655.687</strong> baños</p>
        <p>Ahorramos el equivalente de CO2 de <strong className='strong-underline'>59.033.858 </strong>kms recorridos en automóvil</p>
        <p>Salvamos <strong className='strong-underline'>728.122</strong> vidas animales</p>
      ...
      <div className='landing-three-card-two'>
        ...
        <p><strong className='strong-underline'>Triplicamos los ingresos</strong> en 2021 alcanzando los 17,7M€</p>
        <p>Más de <strong className='strong-underline'>12.500 puntos de venta en todo el mundo</strong></p>
        <p><strong className='strong-underline'>22 países</strong></p>
        <p className='landing-three-card-one-grey'>*basado en Ingresos de €17,7M <br />y -5,7M EBITDA para 2021</p>
      </div>
